...
(function(){
	...
	const margin = {top: 100, right: -5, bottom: -50, left: 65};
...
(function () {
	const margin = {top: 105, right: -10, bottom: -50, left: 45};
	...
	legend.append("text")
	  ...
	  .text(function(d, i) { 
	    switch (i) {
	      case 0: return "Covid-19 deaths in the community";
	      case 1: return "Covid-19 deaths in prisons";
	    }
	  });
